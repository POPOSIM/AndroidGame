    ...
    public void onCreate(Bundle savedInstanceState) {
		...
		startBtn.setOnClickListener(new Button.OnClickListener() {
			public void onClick(View v) {
				...
				intent.setClass(AndroidGameActivity.this, Game.class);
		...
		introBtn.setOnClickListener(new Button.OnClickListener() {
			public void onClick(View v) {
				Intent intent = new Intent();
				intent.setClass(AndroidGameActivity.this, Instruction.class);
				startActivity(intent); // 呼叫新的 Activity
			}
		});
		...
		exitBtn.setOnClickListener(new Button.OnClickListener() {
			public void onClick(View v) {
				AndroidGameActivity.this.finish(); // 關閉目前 Activity
			}
		});
	}
}